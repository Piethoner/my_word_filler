...
DOC_MAP = {
        ...
        u'承包方（乙方）': [
                ...
                [REPLACE_BY_REGEX, r'承包方(?:\(|（)以下简称乙方(?:\)|）)：(.*)', True],
        ...
        u'合同名称': [
                ...
                [REPLACE_BY_REGEX, r'双方经协商于(?:.*?)年(?:.*?)月(?:.*?)日签订了(.*?)合同', True]
        ],
        u'工程名称': [
                # [INSERT_BY_MATCH, u'项目施工总承包工程。', True, True, 0],
                [REPLACE_BY_REGEX, r'工程名称：( +?)(?:项目施工总承包)?工程', True],
                [REPLACE_BY_REGEX, r'对于贵公司与我公司就(.*?)项目签订', True],
                [REPLACE_BY_REGEX, r'我公司已与在贵公司(.*?)项目施工', True],
                [REPLACE_BY_REGEX, r'若在( +?)项目', True]
        ],
        u'工程地点': [
                [SPLIT_TYPE, (u'市', 2, 0), [REPLACE_BY_REGEX, r'1.2 工程地点：(.*?)市', True]],
                [SPLIT_TYPE, (u'市', 2, 1), [INSERT_BY_REGEX, r'1.2 工程地点：(?:.*?)市', False, True, 0]],
                [REPLACE_BY_REGEX, u'工程地点：( +)', True],  # 这里容易与前面两条产生冲突，只能用这种写法
        ],
        u'建筑面积': [
        ...
        u'工程内容': [
                [REPLACE_BY_REGEX, u'包含：(.*?)。详细见附件《总包及分包界面划分表》。详细见附件《总包及分包界面划分表》。详细见附件《总包及分包界面划分表》', True]
        ],
        u'工程质量标准': [
                [INSERT_BY_MATCH, u'本工程质量标准为：', False, True, 0]
        ],
        u'开票方纳税人资质': [
                [MAKE_CHOICE, u'增值纳税人类型及计税方法', {
                        u'增值税一般纳税人': 1,
                        u'增值税小规模纳税人': 26,
                }],
        ],
        u'计税方法':[
                [DEPENDENT_TYPE, u'开票方纳税人资质', {
                        u'增值税一般纳税人': [MAKE_CHOICE, u'(|)增值税一般纳税人', {
                                u'一般计税方法': 0,
                                u'简易计税方法': 7
                        }],
                        u'增值税小规模纳税人': [MAKE_CHOICE, u'(|)增值税小规模纳税人', {
                                u'简易计税方法': 0
                        }]
                }]
        ],
        u'发票类型': [
                [MAKE_CHOICE, u'开具发票类型及适用税率或征收率', {
                        u'增值税专用发票': 1,
                        u'增值税普通发票': 29,
                        u'除增值税专用发票以外的其他增税扣税凭证': 57
                }]
        ],
        u'税率': [
                [DEPENDENT_TYPE, u'发票类型', {
                        u'增值税专用发票': [MAKE_CHOICE, u'(|)增值税专用发票', {
                                u'13%': 2,
                                u'9%': 7,
                                u'6%': 11,
                                u'3%': 15
                        }],
                        u'增值税普通发票': [MAKE_CHOICE, u'(|)增值税普通发票', {
                                u'13%': 2,
                                u'9%': 7,
                                u'6%': 11,
                                u'3%': 15
                        }],
                        u'除增值税专用发票以外的其他增税扣税凭证': [MAKE_CHOICE, u'(|)除增值税专用发票以外的其他增税扣税凭证', {
                                u'13%': 2,
                                u'9%': 7,
                                u'6%': 11,
                                u'3%': 15
        ...
        u'水电费A/B模式': [
                [MAKE_CHOICE, u'现场水电费计量采用', {
                        u'A模式': 0,
                        u'B模式': 5
                }]
        ],
        u'发票开具的两种模式选择': [
                [MAKE_CHOICE, u'发票开具的两种模式选择：', {
                        u'A模式': 0,
                        u'B模式': 5
                }]
        ],
        u'甲方代表': [
                [REPLACE_BY_REGEX, r'甲方驻工地代表为(.*?)。', True]
        ],
        u'乙方代表': [
                [REPLACE_BY_REGEX, r'乙方驻工地代表为(.*?)。', True]
        ],
        u'监理单位': [
        ...
        u'工程保修阶段甲方的代表部门': [
                [REPLACE_BY_REGEX, u'本工程保修阶段甲方的代表部门为(.*?)，乙', True],
        ],
        u'纳税人识别码': [
        ...
        u'地址及联系电话': [
                [INSERT_BY_MATCH, u'地址及联系电话', False, False, 0]
        ],
        u'编制说明': [
                []
        ],
